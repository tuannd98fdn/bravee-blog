...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    href: 'https://github.com/tuannd98fdn',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/tuan-nguyen-dinh-283176302/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className={styles.inner}>
        <div className={styles.top}>
          ...
          <div className={styles.links}>
            <div className={styles.linkGroup}>
              ...
              <a href="/tutorials" className={styles.footerLink}>Tutorials</a>
              <a href="/til" className={styles.footerLink}>TIL</a>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} Bravee. All rights reserved.
          </p>
